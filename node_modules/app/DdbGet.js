...
function DdbGet() {
  ...
  this.conclude = function(data,hasMech) {
    ...
    if(!hasMech) {
      self.deleteFieldFromData("dm", data.id);
      self.deleteFieldFromData("hp", data.id);
      self.deleteFieldFromData("t",  data.id);
      self.deleteFieldFromData("y",  data.id);
    }
