...
var DdbUser = function(event,context,silent) {
...
DdbUser.prototype.checkPassFail=function() {
  ...
  if(pf>=MAX_PASS_FAIL) { this.context.fail("Account locked."); return false; }
  return true;
};

DdbUser.prototype.incrementPassFail=function() {
...
DdbUser.prototype.updateAccountNumbers=function(lpns,cbFun) {
...
DdbUser.prototype.loginCore=function() {
  if(!this.event.hasOwnProperty("email")||!this.event.hasOwnProperty("pass")) {
    this.context.fail("Missing email or password");
    return;
  }
  var self=this;
...
module.exports.initialize = function (event,context,silent) {
  return new DdbUser(event,context,silent);
};
