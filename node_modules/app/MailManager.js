...
exports.mailSend=function(to,subj,body,context) {
  ...
  function(err,body) {
    if(err) {
      context.fail(err); // Invalid email or Did you update the mailgun parameters in config.php?
    } else {
...
// https://documentation.mailgun.com/api-email-validation.html#email-validation
  ...
  request(options, function(err, result) {
    ...
    if(result.statusCode!=200) callback("Server response "+result.statusCode,false);
