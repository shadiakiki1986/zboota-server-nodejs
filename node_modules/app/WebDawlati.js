...
if(!data.hasOwnProperty("y")||!data.hasOwnProperty("hp")||!data.hasOwnProperty("t")||!data.hasOwnProperty("n")||!data.hasOwnProperty("a")) {
        ...
        request.post(
            ...
            function (error, response, body) {
                if (error || response.statusCode != 200) {
                  callbackFn("Not available. "+error+". Status: "+response.statusCode);
                  return;
                }
